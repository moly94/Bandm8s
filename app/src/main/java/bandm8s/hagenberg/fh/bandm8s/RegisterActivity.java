...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     * @return true if valid or false if notb
     */
    ...
    /**
     * Creates User in Firebase Authentication + Database
     */
    ...
    /**
     * Shows a nice Progressbar
     * @param show true if should be shown, false to stop
     */
